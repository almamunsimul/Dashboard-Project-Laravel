                ...
                <div class="col-md-3 top_right_menu text-end">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="fas fa-cog"></i> Manage Account</a></li>
                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{route('payment.view')}}"><i class="fas fa-images"></i> Bkash Payment</a></li>
                            <li><a href="#"><i class="fas fa-comments"></i> Contact Message</a></li>
                            <li><a href="#"><i class="fas fa-globe"></i> Live Site</a></li>
                            @if(Auth::user()->role_id==1)
                            <li><a href="{{route('banner.recycle.all')}}"><i class="fas fa-trash"></i> Recycle Bin</a></li>
                            @endif
        ...
        <div class="container-fluid footer_part">
            <div class="row">
                ...
                <div class="col-md-10 copyright">
                    <p>Copyright &copy; 2025 | All rights reserved by Dashboard | Development By <a href="#">Md Al Mamun</a></p>
                </div>
                <div class="clr"></div>
            </div>
        </div>
